...
interface FormState {
  ...
  dedicatedAITeam: string;
  primaryAIGoal: string;
  implementationTimeline: string;
  decisionAuthority: string;
  annualAIBudget: string;
  teamChangeReadiness: number;
  teamAILiteracy: number;
...
const INITIAL: FormState = {
  ...
  securityCompliance: "",
  successMeasurementClarity: "",
  metricsToTrack: [],
  baselineMeasurement: "",
  roiExpectation: "",
  aiGovernanceFramework: "",
  riskMitigationConcerns: [],
...
function getReadinessByPct(pct: number) {
  ...
  if (pct >= 75)
    return {
      ...
      desc: "Strong foundation — ready to expand from pilot to scale.",
      color: "#1EB49C",
    };
  if (pct >= 60)
    return {
      ...
      desc: "Building capabilities systematically toward your first pilot.",
      color: "#F59E0B",
    };
  if (pct >= 40)
    return {
      ...
      desc: "Early-stage exploration — foundation work comes first.",
      color: "#F97316",
    };
  return {
    pct,
    level: "Getting Started",
    desc: "Education and planning are the right next steps.",
    color: "#EF4444",
  };
}
...
const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    required: true,
    sublabel: "We will send your full AI Readiness Report to this email.",
  },
  {
    id: "companyName",
  ...
  {
    id: "aiAdoptionStage",
    label: "Where is your organization in its AI journey?",
    type: "radio",
    required: true,
    cols: 2,
  ...
  {
    id: "monthlyAISpend",
    label: "What is your approximate monthly AI spend?",
    type: "radio",
    required: true,
    cols: 2,
  ...
  {
    id: "dedicatedAITeam",
    label: "Do you have dedicated AI resources or team?",
    type: "radio",
    required: true,
    cols: 2,
    options: [
  ...
  {
    id: "primaryAIGoal",
    label: "What is your primary goal for AI?",
    type: "radio",
    required: true,
    options: [
  ...
  },
  {
    ...
    label: "What is your decision-making authority?",
    type: "radio",
    required: true,
    options: [
      "Decision-maker",
  ...
  {
    id: "annualAIBudget",
    label: "What is your annual budget for AI investment?",
    type: "radio",
    required: true,
    options: [
      "Not yet determined",
  ...
  {
    id: "teamChangeReadiness",
    label: "How open is your team to changing how they work?",
    sublabel: "1 = Very resistant · 5 = Highly enthusiastic",
    type: "slider",
    min: 1,
    max: 5,
    sliderLabels: ["Resistant", "Enthusiastic"],
  },
  {
    id: "teamAILiteracy",
    label: "How well does your team understand AI?",
    sublabel: "1 = No knowledge · 5 = Expert level",
    type: "slider",
    min: 1,
    max: 5,
    sliderLabels: ["No knowledge", "Expert"],
  },
  {
    id: "leadershipBuyIn",
    label: "How strong is leadership buy-in for AI?",
    type: "radio",
    required: true,
    cols: 2,
  ...
  {
    id: "ethicalConcerns",
    label: "Any ethical or compliance concerns?",
  ...
  {
    id: "topChallenges",
    label: "What are your top challenges?",
  ...
  {
    id: "immediateHelp",
    label: "What immediate help are you looking for?",
    type: "textarea",
    placeholder: "Describe your most pressing AI challenge…",
  },
  {
    id: "hearAboutUs",
    label: "How did you hear about Madavi?",
    type: "select",
    required: true,
    options: [
      "LinkedIn",
  ...
  {
    id: "dataAvailability",
    label: "How would you describe your organization's data?",
    type: "radio",
    required: true,
    cols: 2,
    options: [
      "Clean and accessible",
      "Exists, needs cleaning",
      "Scattered/siloed",
  ...
  {
    id: "dataGovernance",
    label: "How mature is your data governance?",
    type: "radio",
    required: true,
    cols: 2,
    options: [
  ...
  {
    id: "dataChallenges",
    label: "What data challenges do you face?",
    sublabel: "Select all that apply.",
    type: "checkbox",
    cols: 2,
    options: [
  ...
  },
  {
    ...
    label: "How easily can your team access the data they need?",
    sublabel: "1 = Very difficult · 5 = Instant access",
    type: "slider",
    min: 1,
    max: 5,
    sliderLabels: ["Very difficult", "Instant access"],
  },
  {
    id: "itInfrastructure",
  ...
  {
    id: "technicalTalent",
    label: "What is your team's technical AI capability?",
    type: "radio",
    required: true,
    options: [
      "Strong team with AI experience",
      "Capable team, learning AI",
      "Basic IT, no AI expertise",
    ],
  },
  {
    id: "integrationCapability",
    label: "How strong are your integration capabilities?",
    type: "radio",
    required: true,
    options: [
      "APIs well-established",
  ...
  },
  {
    ...
    label: "What is your security & compliance posture?",
    type: "radio",
    required: true,
    options: [
  ...
  {
    id: "successMeasurementClarity",
    label: "How clearly defined are your AI success metrics?",
    type: "radio",
    required: true,
    options: [
      "Clear KPIs defined and tracked",
      "KPIs identified, not tracked",
      "General goals only",
  ...
  {
    id: "metricsToTrack",
    label: "Which metrics do you intend to track?",
    sublabel: "Select all that apply.",
    type: "checkbox",
    options: [
      "Cost savings",
  ...
  },
  {
    ...
    label: "Do you currently track performance baselines?",
    type: "radio",
    required: true,
    options: [
      "Track current performance",
      "Some baseline exists",
      "Limited baseline",
      "No baseline",
    ],
  },
  {
    id: "roiExpectation",
    label: "When do you expect to see ROI from AI?",
    type: "radio",
    required: true,
    options: ["0–6 months", "6–12 months", "12–24 months", "Beyond 24 months"],
  },
  {
    id: "aiGovernanceFramework",
    label: "Do you have an AI governance framework?",
    type: "radio",
    required: true,
    options: [
  ...
  {
    id: "riskMitigationConcerns",
    label: "What are your top risk concerns?",
    sublabel: "Select all that apply.",
    type: "checkbox",
    options: [
      "Model accuracy",
  ...
  },
  {
    ...
    required: true,
    options: [
      "Heavily regulated, critical compliance needs",
  ...
  {
    id: "riskAppetite",
    label: "What best describes your organization's risk appetite?",
    type: "radio",
    required: true,
    options: [
      "Willing to pilot and iterate",
      "Cautious, need proven solutions",
      "Risk-averse, need guarantees",
    ],
  },
  {
    id: "subscribeNewsletter",
    label: "Stay updated with AI insights",
    type: "toggle",
...
export default function AIAuditForm() {
  ...
  const currentStepQuestions = currentStepQuestionIndices.map(
    (i) => QUESTIONS[i],
  );
  ...
  function toggleCheckbox(key: keyof FormState, opt: string, max?: number) {
    ...
    if (arr.includes(opt)) {
      set(key, arr.filter((v) => v !== opt) as any);
      return;
    }
  ...
  useEffect(() => {
    const handler = (e: KeyboardEvent) => {
      ...
      const hasMultilineInput = currentStepQuestions.some((q) =>
        ["radio", "checkbox", "slider", "toggle"].includes(q.type),
      );
  ...
  }, [step, form, advance, currentStepQuestions]);
  ...
  if (submitted) {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-6">
        ...
        >
          <div
            className="size-20 rounded-full flex items-center justify-center text-white text-3xl mx-auto mb-8"
            style={{ background: r.color }}
          >
            ✓
          </div>
          <h2 className="font-display text-4xl font-bold text-zinc-900 mb-3">
            Your assessment is complete.
          </h2>

          {/* Score display */}
          <div
            className="rounded-2xl border-2 border-zinc-100 p-8 mb-6"
          ...
          <div className="mb-6 p-5 rounded-xl bg-[#F0FDFA] border border-[#005B65]/20 text-left">
            <p className="text-sm font-semibold text-[#005B65] mb-2">
              📧 Your full report is on the way
            </p>
            <p className="text-sm text-zinc-600 leading-relaxed">
              The complete AI Readiness Assessment Report has been sent to{" "}
              <strong>{form.workEmail}</strong>. You should receive it shortly.
              If you do not see it, check your spam folder or contact us at{" "}
              <a
                href="mailto:hi@madavi.co"
                className="text-[#005B65] underline"
              >
                hi@madavi.co
              </a>
              .
          ...
          <a
            href="/"
            className="inline-block rounded-full px-8 py-3 font-semibold text-white text-sm"
        ...
        <div className="w-full max-w-2xl">
          <AnimatePresence mode="wait" custom={dir}>
            ...
            >
              ...
              <div>
                <span
                  className="text-sm font-bold tracking-wider flex items-center gap-1.5"
                  style={{ color: BRAND }}
                >
                  {step + 1}{" "}
                  <svg
                ...
                <h2 className="text-3xl font-light tracking-tight text-zinc-800 mt-3 md:text-4xl">
                  {stepName}
                </h2>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {currentStepQuestions.map((q, idx) => (
                  <div
                    key={q.id}
                    className={`flex flex-col gap-3 ${currentStepQuestions.length === 1 || (idx === currentStepQuestions.length - 1 && currentStepQuestions.length % 2 === 1) ? "sm:col-span-2" : ""}`}
                  >
                    ...
                    {q.type === "select" && (
                      <div className="relative">
                        <select
                          value={form[q.id] as string}
                          onChange={(e) => {
                            set(q.id, e.target.value as any);
                          }}
                        ...
                        <svg
                          className="absolute right-2 bottom-2 pointer-events-none text-zinc-400"
                          width="16"
                          height="16"
                          viewBox="0 0 20 20"
                          fill="none"
                    ...
                    {q.type === "radio" && (
                      <div
                        ...
                        className={!q.cols ? "flex flex-col gap-1.5" : ""}
                      >
                        {q.options!.map((o) => (
                          <button
                            key={o}
                            ...
                            className={`flex items-center gap-2 rounded px-3 py-2 text-sm text-left transition-all ${
                              form[q.id] === o
                                ? "bg-[#EEF6F7] text-[#005B65] font-medium"
                                : "text-zinc-700 hover:bg-zinc-50"
                            }`}
                          >
                            <span
                              className={`size-4 rounded-full border-2 shrink-0 flex items-center justify-center transition-colors ${form[q.id] === o ? "border-[#005B65] bg-[#005B65]" : "border-zinc-300 bg-white"}`}
                            >
                              {form[q.id] === o && (
                        ...
                        {q.options!.map((o) => {
                          ...
                          return (
                            <button
                              key={o}
                              type="button"
                              onClick={() => toggleCheckbox(q.id, o, q.max)}
                              disabled={dis}
                              className={`flex items-center gap-2 rounded px-3 py-2 text-sm text-left transition-all ${
                                sel
                                  ? "bg-[#EEF6F7] text-[#005B65] font-medium"
                            ...
                            >
                              <span
                                className={`size-4 rounded border shrink-0 flex items-center justify-center transition-colors ${sel ? "border-[#005B65] bg-[#005B65]" : "border-zinc-300 bg-white"}`}
                              >
                                {sel && (
                                  <svg
                                    width="10"
                    ...
                    {q.type === "slider" && (
                      <div className="flex flex-col gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            set(q.id, Number(e.target.value) as any)
                          }
                    ...
                    {q.type === "toggle" && (
                      <button
                        type="button"
                        onClick={() =>
                          set(q.id, !(form[q.id] as boolean) as any)
                        }
                        className={`flex items-center gap-3 rounded-lg border-2 px-4 py-3 text-left text-sm transition-all w-fit ${
                          form[q.id]
                            ? "border-[#005B65] bg-[#EEF6F7] text-[#005B65] font-medium"
                            : "border-zinc-200 bg-white text-zinc-800 hover:border-zinc-400"
                        }`}
                      >
                        <span
                          className={`w-10 h-6 rounded-full shrink-0 flex items-center transition-colors ${form[q.id] ? "bg-[#005B65]" : "bg-zinc-300"}`}
                        >
                          <span
                            className={`w-5 h-5 rounded-full bg-white transition-transform ${form[q.id] ? "translate-x-5" : "translate-x-0"}`}
                          />
                        </span>
                        {q.options?.[0] || "Enable"}
                      </button>
