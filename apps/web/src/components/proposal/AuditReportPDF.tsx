      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ marginTop: 8, padding: 14, backgroundColor: "#F0FDFA", borderRadius: 8, border: `1 solid ${BRAND}20` }}>
          ...
          <Text style={{ fontSize: 8, color: "#374151", lineHeight: 1.6 }}>
            ...
            Madavi&rsquo;s Human-Centric AI Framework (HCAIF) addresses readiness gaps across strategy, culture, data, and infrastructure — ensuring your team is prepared before a single tool is deployed.{"\n\n"}
