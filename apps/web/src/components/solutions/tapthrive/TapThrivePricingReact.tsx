...
const tiers: PricingTier[] = [
  {
    ...
    ctaHref: WA_BASE + encodeURIComponent("Hi, I'd like to get started with TapThrive — the Tap plan"),
    features: [
  ...
  },
  {
    ...
    popular: true,
    ctaLabel: "Get started on WhatsApp",
    ctaHref: WA_BASE + encodeURIComponent("Hi, I'd like to get started with TapThrive — the Tap + Grow plan"),
    features: [
      "Everything in Tap",
  ...
  },
  {
    ...
    popular: false,
    ctaLabel: "Get started on WhatsApp",
    ctaHref: WA_BASE + encodeURIComponent("Hi, I'd like to get started with TapThrive — the Tap + Glow plan"),
    features: [
