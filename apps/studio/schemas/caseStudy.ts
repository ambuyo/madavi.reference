...
export const singleWork = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "aiStudioServiceRefs",
      title: "The AI Studio",
      type: "array",
      of: [{ type: "reference", to: [{ type: "service" }] }],
      options: {
        filter: 'category == "ai-studio"',
      },
      description: "AI Studio services provided to the client",
    }),
    // Legacy string fields — preserved for data integrity, hidden from UI
    defineField({
      name: "imcServices",
      title: "IMC Services (Legacy)",
      type: "array",
      of: [{ type: "string" }],
      hidden: true,
    }),
    defineField({
      ...
      title: "AI Studio Services (Legacy)",
      type: "array",
      of: [{ type: "string" }],
      hidden: true,
    }),
